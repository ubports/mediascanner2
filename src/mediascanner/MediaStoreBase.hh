...
public:
    ...
    virtual std::vector<MediaFile> listSongs(const Filter &filter, int limit=-1) const = 0;
    virtual std::vector<Album> listAlbums(const Filter &filter, int limit=-1) const = 0;
